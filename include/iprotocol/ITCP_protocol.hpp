...
// Last update Wed Dec  9 18:09:19 2015 Antoine Plaskowski
//
...
public:
  ...
  private:
    std::string	m_name;
    std::string	m_owner;
    uint8_t	m_number_player;
    uint8_t	m_number_player_max;
  };
  class	Callback
  {
  public:
...
public:
  ...
  // virtual void	send_meta_params(std::list<Param *> const&params);
