...
// Last update Sun Dec 27 00:35:13 2015 Alaric Degand
//

#include "View.hpp"
#include "Text.hpp"

Text::Text(float pos_x, float pos_y, std::string const &txt, sf::Font const &thefont) : AElement(TEXT, ""), sf::Text(txt, thefont, 30)
{
